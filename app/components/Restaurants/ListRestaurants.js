       ...
       <TouchableOpacity onPress={goRestaurant}>
           <View style={styles.viewRestaurant}>
             <View style={styles.viewRestaurantImage}>
               <Image
                resizeMode="cover" // ocupa todo el ancho de la vista 
...
// para que salga un loading al cargar los nuevos restaurantes
    ...
    if(isLoading){
        ...
        return(
            <View style={styles.notFoundRestaurants}>
                <Text>No quedan mas restaurantes por cargar</Text>
            </View>
        )
    }
}
